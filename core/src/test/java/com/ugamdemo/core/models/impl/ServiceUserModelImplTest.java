...
class UserNamesImplTest {
    ...
    @Test
    void getUserNames() throws RepositoryException, NoSuchFieldException, LoginException {

        ServiceUserModel userNames = aemContext.request().adaptTo(ServiceUserModel.class);
